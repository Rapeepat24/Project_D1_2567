<template>
  <v-responsive max-width="100%">
      <div class="container " style="background-image: url(https://i.pinimg.com/originals/0b/a3/d6/0ba3d60362c7e6d256cfc1f37156bad9.jpg); background-size: cover;
      ">
      <!-- Light Bulb Card -->
          ...
          <v-row class="text-center">
              ...
              <v-col cols="12" sm="12" md="12">
                  <v-card class="mx-auto" max-width="800" hover style="border-radius: 15px;">
                      ...
                      <v-card-text>
                          <v-row>
                              ...
                              <v-col cols="6" sm="6" md="6">
                                  ...
                                  <v-progress-circular :model-value="value_temp" :rotate="360" :size="80" :width="5"
                                      color="red">
                              ...
                              <v-col cols="6" sm="6" md="6">
                                  ...
                                  <v-progress-circular :model-value="value_humi" :rotate="360" :size="80" :width="5"
                                      color="blue">
                          ...
                          <v-row>
                              ...
                              <v-col cols="6" sm="6" md="6">
                                  ...
                                  <v-progress-circular :model-value="totalValueT" :rotate="360" :size="80"
                                      :width="5" color="red">
                                      {{ totalValueT }} °C
                                  </v-progress-circular>
                                  <v-row>
                              ...
                              <v-col cols="6" sm="6" md="6">
                                  ...
                                  <v-progress-circular :model-value="totalValueH" :rotate="360" :size="80"
                                      :width="5" color="blue">
                                      {{ totalValueH }} %
                                  </v-progress-circular>
                                  <v-row>
                      ...
                      <v-card class="mx-auto" max-width="500" hover style="border-radius: 10px;">
                      <v-card-title>
...
export default {
  ...
  methods: {
      ...
      onMqttConnect() {
          ...
          this.client.subscribe('Rapeepat');
